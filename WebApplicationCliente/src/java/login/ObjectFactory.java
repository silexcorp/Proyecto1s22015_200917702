...
public class ObjectFactory {
    ...
    private final static QName _LoginUser_QNAME = new QName("http://login/", "loginUser");
    private final static QName _LoginUserResponse_QNAME = new QName("http://login/", "loginUserResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://login/", name = "loginUser")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://login/", name = "loginUserResponse")
